...
if __name__ == '__main__':
    lookup = json.loads((archive.ROOT/'99_系统文件/缓存/临时文件/podcast-shows-lookup.json').read_text(encoding='utf-8-sig'))
    registry = []
    for row in lookup:
    ...
    archive.write_json(archive.ROOT/'99_系统文件/索引/播客学习/shows.json',registry)
